...
def upgrade() -> None:
    ...
    if "baseline_tramitacao" not in tables:
        op.create_table(
            ...
            sa.Column(
                "origem_dados", sqlmodel.sql.sqltypes.AutoString(), nullable=False
            ),
        ...
        op.create_index(
            op.f("ix_baseline_tramitacao_escopo"),
            "baseline_tramitacao",
            ["escopo"],
            unique=False,
        )
        op.create_index(
            op.f("ix_baseline_tramitacao_fase_codigo"),
            "baseline_tramitacao",
            ["fase_codigo"],
            unique=False,
        )
        op.create_index(
            op.f("ix_baseline_tramitacao_origem_dados"),
            "baseline_tramitacao",
            ["origem_dados"],
            unique=False,
        )
        op.create_index(
            op.f("ix_baseline_tramitacao_regime_tramitacao"),
            "baseline_tramitacao",
            ["regime_tramitacao"],
            unique=False,
        )
        op.create_index(
            op.f("ix_baseline_tramitacao_tipo"),
            "baseline_tramitacao",
            ["tipo"],
            unique=False,
        )
    ...
    if "fase_analitica" not in tables:
        ...
        op.create_index(
            op.f("ix_fase_analitica_codigo"), "fase_analitica", ["codigo"], unique=True
        )
        op.create_index(
            op.f("ix_fase_analitica_ordem_logica"),
            "fase_analitica",
            ["ordem_logica"],
            unique=False,
        )
    ...
    if "log_coleta_batch" not in tables:
        op.create_table(
            ...
            sa.Column(
                "mensagem_erro", sqlmodel.sql.sqltypes.AutoString(), nullable=True
            ),
            sa.PrimaryKeyConstraint("id"),
        )
        op.create_index(
            op.f("ix_log_coleta_batch_fonte"),
            "log_coleta_batch",
            ["fonte"],
            unique=False,
        )
    ...
    if "orgaolegislativo" not in tables:
        op.create_table(
            ...
            sa.Column(
                "casa",
                sa.Enum("CAMARA", "SENADO", "AMBAS", name="casalegislativa"),
                nullable=False,
            ),
        ...
        op.create_index(
            op.f("ix_orgaolegislativo_id_origem"),
            "orgaolegislativo",
            ["id_origem"],
            unique=False,
        )
        op.create_index(
            op.f("ix_orgaolegislativo_sigla"),
            "orgaolegislativo",
            ["sigla"],
            unique=False,
        )
    ...
    if "proposicao" in tables:
        ...
        new_cols = {
            "indice_atraso_relativo": sa.Column(
                "indice_atraso_relativo", sa.Float(), nullable=True
            ),
            "indice_atraso_fase_atual": sa.Column(
                "indice_atraso_fase_atual", sa.Float(), nullable=True
            ),
            "indice_espera_improdutiva": sa.Column(
                "indice_espera_improdutiva", sa.Float(), nullable=True
            ),
            "status_atraso": sa.Column(
                "status_atraso", sqlmodel.sql.sqltypes.AutoString(), nullable=True
            ),
            "dias_decorridos_total": sa.Column(
                "dias_decorridos_total", sa.Integer(), nullable=True
            ),
            "dias_esperados_total": sa.Column(
                "dias_esperados_total", sa.Integer(), nullable=True
            ),
            "baseline_grupo_id": sa.Column(
        ...
        op.create_table(
            ...
            sa.Column(
                "ementa_resumida", sqlmodel.sql.sqltypes.AutoString(), nullable=True
            ),
            ...
            sa.Column(
                "orgao_origem", sqlmodel.sql.sqltypes.AutoString(), nullable=True
            ),
            sa.Column("status", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
            sa.Column(
                "orgao_atual", sqlmodel.sql.sqltypes.AutoString(), nullable=False
            ),
            sa.Column(
                "data_apresentacao", sqlmodel.sql.sqltypes.AutoString(), nullable=False
            ),
            sa.Column(
            ...
            sa.Column(
                "link_oficial", sqlmodel.sql.sqltypes.AutoString(), nullable=True
            ),
            sa.Column(
                "data_encerramento", sqlmodel.sql.sqltypes.AutoString(), nullable=True
            ),
    ...
    if "apensamento" not in tables:
        op.create_table(
            ...
            sa.Column(
                "data_apensacao", sqlmodel.sql.sqltypes.AutoString(), nullable=False
            ),
            sa.Column("casa", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
            sa.Column(
                "fonte_endpoint", sqlmodel.sql.sqltypes.AutoString(), nullable=True
            ),
        ...
        op.create_index(
            op.f("ix_apensamento_materia_apensada_id"),
            "apensamento",
            ["materia_apensada_id"],
            unique=False,
        )
        op.create_index(
            op.f("ix_apensamento_materia_principal_id"),
            "apensamento",
            ["materia_principal_id"],
            unique=False,
        )
    ...
    if "evento_tramitacao" not in tables:
        op.create_table(
            ...
            sa.Column(
                "proposicao_id", sqlmodel.sql.sqltypes.AutoString(), nullable=False
            ),
            sa.Column(
                "data_evento", sqlmodel.sql.sqltypes.AutoString(), nullable=False
            ),
            sa.Column("sequencia", sa.Integer(), nullable=False),
            sa.Column("sigla_orgao", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
            sa.Column(
                "descricao_original", sqlmodel.sql.sqltypes.AutoString(), nullable=False
            ),
            sa.Column(
                "tipo_evento", sqlmodel.sql.sqltypes.AutoString(), nullable=False
            ),
            ...
            sa.Column(
                "remessa_ou_retorno", sqlmodel.sql.sqltypes.AutoString(), nullable=True
            ),
        ...
        op.create_index(
            op.f("ix_evento_tramitacao_fase_analitica_id"),
            "evento_tramitacao",
            ["fase_analitica_id"],
            unique=False,
        )
        op.create_index(
            ...
            "evento_tramitacao",
            ["proposicao_id", "data_evento", "sequencia"],
            unique=False,
        )
        op.create_index(
            op.f("ix_evento_tramitacao_proposicao_id"),
            "evento_tramitacao",
            ["proposicao_id"],
            unique=False,
        )
        op.create_index(
            op.f("ix_evento_tramitacao_sigla_orgao"),
            "evento_tramitacao",
            ["sigla_orgao"],
            unique=False,
        )
        op.create_index(
            op.f("ix_evento_tramitacao_tipo_evento"),
            "evento_tramitacao",
            ["tipo_evento"],
            unique=False,
        )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_evento_tramitacao_tipo_evento"), table_name="evento_tramitacao"
    )
    op.drop_index(
        op.f("ix_evento_tramitacao_sigla_orgao"), table_name="evento_tramitacao"
    )
    op.drop_index(
        op.f("ix_evento_tramitacao_proposicao_id"), table_name="evento_tramitacao"
    )
    op.drop_index("ix_evento_tramitacao_prop_data_seq", table_name="evento_tramitacao")
    op.drop_index(
        op.f("ix_evento_tramitacao_fase_analitica_id"), table_name="evento_tramitacao"
    )
    ...
    op.drop_index(
        op.f("ix_baseline_tramitacao_regime_tramitacao"),
        table_name="baseline_tramitacao",
    )
    op.drop_index(
        op.f("ix_baseline_tramitacao_origem_dados"), table_name="baseline_tramitacao"
    )
    op.drop_index(
        op.f("ix_baseline_tramitacao_fase_codigo"), table_name="baseline_tramitacao"
    )
    op.drop_index(
        op.f("ix_baseline_tramitacao_escopo"), table_name="baseline_tramitacao"
    )
