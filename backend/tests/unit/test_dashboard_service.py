...
def session_fixture():
    ...
    with Session(engine) as session:
        ...
        p1 = Proposicao(
            id="1", tipo="PL", numero="1", ano=2024, autor="A", 
            status="Aprovada", orgao_atual="CCJ", ementa="E1",
        ...
        p2 = Proposicao(
            id="2", tipo="PEC", numero="2", ano=2024, autor="B", 
            status="Em tramitação", orgao_atual="LENTO", ementa="E2",
            data_apresentacao="2024-01-01", data_ultima_movimentacao="2024-01-01",
