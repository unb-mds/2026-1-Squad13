...
def test_login_sucesso_reseta_tentativas(auth_service, user_repository, attempt_provider):
    # Setup
    email = "test@example.com"
    password = "password123"
    hashed_password = "hashed_password"
    user = User(id=1, nome="Test", email=email, hashed_password=hashed_password, perfil="analista")
...
def test_login_falha_incrementa_tentativas(auth_service, user_repository, attempt_provider):
    # Setup
    email = "test@example.com"
