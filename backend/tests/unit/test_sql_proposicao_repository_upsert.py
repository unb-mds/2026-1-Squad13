...
def test_upsert_em_lote_idempotencia(session):
    ...
    prop1 = Proposicao(
        id="1", tipo="PL", numero="100", ano=2024, autor="Autor A",
        ementa="Ementa A", data_apresentacao="2024-01-01",
        orgao_origem="Câmara", status="Ativo", orgao_atual="Câmara",
        link_oficial="link", data_ultima_movimentacao="2024-01-01"
    )
...
def test_upsert_em_lote_multiplos(session):
    ...
    props = [
        Proposicao(id="1", tipo="PL", numero="101", ano=2024, autor="A1", ementa="E1", data_apresentacao="2024-01-01", orgao_origem="C", status="S", orgao_atual="O", link_oficial="L", data_ultima_movimentacao="D"),
        Proposicao(id="2", tipo="PEC", numero="1", ano=2024, autor="A2", ementa="E2", data_apresentacao="2024-01-01", orgao_origem="S", status="S", orgao_atual="O", link_oficial="L", data_ultima_movimentacao="D")
    ]
...
def test_upsert_em_lote_case_insensitivity(session):
    ...
    prop = Proposicao(id="1", tipo="pl", numero="200", ano=2024, autor="A", ementa="E", data_apresentacao="2024-01-01", orgao_origem="C", status="S", orgao_atual="O", link_oficial="L", data_ultima_movimentacao="D")
