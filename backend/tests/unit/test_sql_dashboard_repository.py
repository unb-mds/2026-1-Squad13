...
def test_obter_metricas_gerais(session: Session):
    ...
    assert metricas["totalProposicoesTrend"] == {"value": "+12% vs mês anterior", "isPositive": True}
    assert metricas["totalEmTramitacaoTrend"] == {"value": "+8% vs mês anterior", "isPositive": True}
    assert metricas["proposicoesComAtrasoTrend"] == {"value": "-5% vs mês anterior", "isPositive": True}
    assert metricas["tempoMedioTramitacaoTrend"] == {"value": "+3 dias vs trimestre", "isPositive": False}
