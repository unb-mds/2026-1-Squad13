...
def test_obter_metricas_com_filtros(session: Session):
    ...
    p1 = ProposicaoModel(id="1", tipo="PL", numero="1", ano=2024, autor="A", status="Aprovada", orgao_atual="O1", ementa="E1", data_apresentacao="2024-01-01", data_ultima_movimentacao="2024-01-01", tempo_total_dias=10)
    p2 = ProposicaoModel(id="2", tipo="PEC", numero="2", ano=2024, autor="B", status="Rejeitada", orgao_atual="O2", ementa="E2", data_apresentacao="2024-01-01", data_ultima_movimentacao="2024-01-01", tempo_total_dias=20)
...
def test_obter_dados_graficos(session: Session):
    ...
    p1 = ProposicaoModel(id="1", tipo="PL", numero="1", ano=2024, autor="A", status="Aprovada", orgao_atual="O1", ementa="E1", data_apresentacao="2024-01-01", data_ultima_movimentacao="2024-01-01", tempo_total_dias=10)
    p2 = ProposicaoModel(id="2", tipo="PL", numero="2", ano=2024, autor="B", status="Aprovada", orgao_atual="O1", ementa="E2", data_apresentacao="2024-01-01", data_ultima_movimentacao="2024-01-01", tempo_total_dias=30)
