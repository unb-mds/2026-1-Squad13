...
def test_health_success(mock_db_session):
    ...
    with patch("presentation.controllers.health_controller.get_redis_client") as mock_redis, \
         patch("presentation.controllers.health_controller.check_api_connectivity") as mock_api:
