...
- Acompanhamento de tramitação em banco de dados relacional.
- Cálculo de dias parados e tempo de tramitação.
...
- `application`: Orquestração de casos de uso (Services).
- `domain`: Regras de negócio, cálculo de prazos.
- `infrastructure`: Banco de dados, APIs externas (via Adapters), cache.
