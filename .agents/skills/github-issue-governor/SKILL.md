...
- **Interação com Usuário:** Caso haja dúvidas ou ambiguidade quanto à feature correspondente (`feat:f*`), prioridade ou divisão da issue, utilize a ferramenta `ask_question` para alinhar as escolhas interativamente com o desenvolvedor.
