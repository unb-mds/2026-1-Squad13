...
- **Issues**: toda nova necessidade → issue aprovada → implementação.
  - No merge de PRs na branch `develop`, as issues associadas devem ter seu status atualizado para a label `status:merged-develop` (ou similar) e permanecer abertas.
